...
*/
  inth = sht31.readTemperature();
  intt = sht31.readHumidity();
 ...
 */
  ...
  exth = sht32.readTemperature();
  extt = sht32.readHumidity();
    ...
    if (millis() - tpcitire > tpcitit)
     {
        ...
        // interior temperature/humidity
         if (intdht){
          ...
          intt = round(sht31.readTemperature() - 1);
           delay(500);
          //inth = round(dht1.readHumidity());
          inth = round(sht31.readHumidity());
      ...
      // exterior temperature/humidity
        if (extdht){
            ...
            extt = round(sht32.readTemperature() - 1);
             delay(500);
            //exth = round(dht2.readHumidity());
            exth = round(sht32.readHumidity());
            lcd.setCursor(11,3);
          if (extt>=0) {
          lcd.print(" ");
